...
export default function Home({ token }) {
  ...
  return (
    ...
    <div>
        <Navbar />
        <h1 className="head">Persian Cat: Cat Breed Profile</h1>
        <div className="cat">
        <img src="https://www.thesprucepets.com/thmb/EsxD7IrW92nCnII63BaUKg_x2Os=/960x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/exotic-flat-face-persian-short-hair_t20_b8zdjB-5c45254e46e0fb00015ca255.jpg" alt="Lamp" width="500" height="850"></img>
        <h5 className="message1">The dignified Persian feline breed is characterized by its long coat and sweet temperament, though Persians tend to limit their affections to just those humans they are closest to. Among purebred cats, Persians are revered for their glamorous good looks and calm demeanor.
